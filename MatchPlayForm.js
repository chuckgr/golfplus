...
class MatchPlayForm {
  ...
  create() {
    ...
    var form = FormApp.create('Golf+ for fun Tournament Player Select');
    
    /** Description of the form */
    form.setDescription('Select the players to participate in the Match Play or Best Ball Tournament');
    
    /** We will not collect email addresses so we can tabulate per person */
